...
## Change Boundary
File implementasi yang menjadi scope perubahan:
- `schema.sql`
- `queries.sql`
- `src/warehouse.py`

Input pada `data/processed/`, quality gates, dan validator adalah contract fixtures. Jangan diubah untuk membuat check terlihat lolos.
